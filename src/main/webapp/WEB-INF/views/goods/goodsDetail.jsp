...
function fn_order_each_goods(goods_id,goods_title,goods_sales_price,fileName,goods_point,delivery_price){
    ...
    i_order_goods_delivery_price.value= delivery_price;
...
<div class="myGoodsContainer">
	...
	<div id="detail_table">
		...
		<div class="row">
		<a class="btn btn-dark mt-2" style="background-color:#BEACC4; border-color:white; " href="javascript:fn_order_each_goods('${goods.goods_id }','${goods.goods_title }','${goods.goods_sales_price}','${goods.goods_fileName}','${goods.goods_point}','${goods.goods_delivery_price}');" role="button">구매하기</a>
